...
_IO<_Unit> mainFunc = []() {auto _300 = (uint64_t)1;auto _302 = (uint64_t)2;auto _303 = _List<uint64_t>::_Nil();auto _301 = _List<uint64_t>::_Cons(_302,_303);auto _298 = _List<uint64_t>::_Cons(_300,_301);auto _306 = (uint64_t)2;auto _308 = (uint64_t)3;auto _309 = _List<uint64_t>::_Nil();auto _307 = _List<uint64_t>::_Cons(_308,_309);auto _304 = _List<uint64_t>::_Cons(_306,_307);auto _305 = _List<_List<uint64_t>>::_Nil();auto _299 = _List<_List<uint64_t>>::_Cons(_304,_305);auto _295 = _List<_List<uint64_t>>::_Cons(_298,_299);auto _312 = (uint64_t)3;auto _314 = (uint64_t)4;auto _315 = _List<uint64_t>::_Nil();auto _313 = _List<uint64_t>::_Cons(_314,_315);auto _310 = _List<uint64_t>::_Cons(_312,_313);auto _318 = (uint64_t)4;auto _320 = (uint64_t)5;auto _321 = _List<uint64_t>::_Nil();auto _319 = _List<uint64_t>::_Cons(_320,_321);auto _316 = _List<uint64_t>::_Cons(_318,_319);auto _317 = _List<_List<uint64_t>>::_Nil();auto _311 = _List<_List<uint64_t>>::_Cons(_316,_317);auto _296 = _List<_List<uint64_t>>::_Cons(_310,_311);auto _297 = multM;auto _294 = baseRun2(_295)(_296)(_297); return _294;}();
//////////////////////////////////////
